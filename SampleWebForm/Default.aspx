        ...
        try
        {
            if (txtimgcode.Text == this.Session["CaptchaImageText"].ToString())
            {
                ...
                */
                ...
                System.Net.NetworkCredential Credentials = new NetworkCredential("cs@fivestarcertified.com", "XXXXX");
                                    ...
                                    <p class="clear-a">
                                        ...
                                        <span class="float-l input-field">
                                            <%--<select id="zoom">
                                                ...
                                                <option value="Advertising On FiveStarCertified.com">Advertising On FiveStarCertified.com</option>
                                                <option value="Writing A Review">Writing A Review</option>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:DropDownList ID="ddlIntrest" runat="server" Style="width: 300px">
                                                            ...
                                                            <asp:ListItem>Investor Information</asp:ListItem>
                                                            <asp:ListItem>Press Information</asp:ListItem>
                                                            <asp:ListItem>Worldwide Search</asp:ListItem>
