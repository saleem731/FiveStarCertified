...
function checkVersion(e) {
    var t = "You're not using Internet Explorer.",
        n = getInternetExplorerVersion(),
        r = parseInt(e) + 1;
    if (n > -1) return e == 0 ? !0 : n == e ? !0 : !1
}

function checkFFVersion() {
        return $("html").hasClass("no-csstransitions") ? 3 : 4
    }(function(e, t, n) {
        function r() {
            var e = D;
            return e.loader = {
        ...
        function i(e, t, n) {
            var r = t == "c" ? N : T;
            return m = 0, t = t || "j", L(e) ? s(r, e, t, this.i++, c, n) : (v.splice(this.i++, 0, e), v.length == 1 && o()), this
        }

        function s(e, n, r, i, s, u) {
            function a() {
                !d && l(c.readyState) && (g.r = d = 1, !m && f(), c.onload = c.onreadystatechange = null, h(function() {
                    w.removeChild(c)
                }, 0))
            }
            ...
            c.src = c.data = n, !y && (c.style.display = "none"), c.width = c.height = "0", e != "object" && (c.type = r), c.onload = c.onreadystatechange = a, e == "img" ? c.onerror = a : e == "script" && (c.onerror = function() {
                g.e = g.r = 1, o()
            }), v.splice(i, 0, g), w.insertBefore(c, y ? null : p), h(function() {
                d || (w.removeChild(c), g.r = g.e = d = 1, f())
            }, D.errorTimeout)
        }
        ...
        function u(e) {
            ...
            if (!e.e && (S || g)) {
                var i = function(e) {
                    h(function() {
                        if (!r) try {
                            e.sheet.cssRules.length ? (r = 1, f()) : i(e)
                        } catch (t) {
        ...
        function a(e) {
            ...
            n.src = e.s, n.onreadystatechange = n.onload = function() {
                !r && l(n.readyState) && (r = 1, f(), n.onload = n.onreadystatechange = null)
            }, h(function() {
                r || (r = 1, f())
        ...
        D = function(e) {
            function t(e, t) {
                function n(e) {
                    if (L(e)) i(e, u, t, 0, r);
                        ...
                        for (a in e) e.hasOwnProperty(a) && i(e[a], u, t, a, r)
                }
                var r = !!e.test,
                    s = r ? e.yep : e.nope,
                    o = e.load || e.both,
            ...
            function i(e, t, i, o, u) {
                var a = s(e),
                    f = a.autoCallback;
                if (!a.bypass) {
                    t && (t = A(t) ? t : t[e] || t[o] || t[e.split("/").pop().split("?")[0]]);
                    if (a.instead) return a.instead(e, t, i, o, u);
                    i.load(a.url, a.forceCSS || !a.forceJS && /css$/.test(a.url) ? "c" : n, a.noexec), (A(t) || A(f)) && i.load(function() {
                        r(), t && t(a.origUrl, u, o), f && f(a.origUrl, u, o)
                    })
                }
            }
            ...
            var o, u, a = this.yepnope.loader;
            if (L(e)) i(e, 0, a, 0);
            else if (C(e))
                for (o = 0; o < e.length; o++) u = e[o], L(u) ? i(u, 0, a, 0) : C(u) ? D(u) : k(u) && t(u, a);
            else k(e) && t(e, a)
    ...
    })(this, this.document), window.Modernizr = function(e, t, n) {
        function r(e) {
            g.cssText = e
        }
        ...
        return h.input || l(), h.addTest = function(e, t) {
            ...
            function(e, t) {
                ...
                e.html5 = g, a(t)
            }(this, t), h._version = c, h._prefixes = E, h._domPrefixes = T, h._cssomPrefixes = x, h.hasEvent = _, h.testProp = function(e) {
                return u([e])
