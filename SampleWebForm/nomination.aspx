...
<script runat="server">    
    protected void btnSubmit_Click1(Object sender, EventArgs e)
    {
        try
        {
            ...
            {
                StringBuilder stringBuilder = new StringBuilder("<table border='1' cellspacing='2' cellpadding='2'><tr><td>First Name</td><td >%FName%</td></tr><tr><td>Last Name</td><td>%LName%</td></tr><tr><td>Email</td><td>%Email%</td></tr><tr><td>Phone</td><td>%phone%</td></tr><tr><td>City</td><td>%City%</td></tr><tr><td>Interested In</td><td>%Intr%</td></tr><tr><td>Message</td><td>%Msg%</td></tr></table>");
...
<head id="ctl00_Head1">
    <title>Nominate Business Or Product</title>
            ...
            <div id="site-body" class="site-body ">
                <section id="page" class="page clearfix skin-4 margin-vertical pad-gutter-all">
                    <div class="clearfix margin-lead-vertical pad-horizontal richtext">
                        ...
                        -->
                            <h1>Nominate A Business Or Product <!--end .col-->                            </h1>
                            <div class="row">
                              <form id="form1" runat="server" class="margin-a contact-form">
                                <asp:Label runat="server" ID="lblStatus" ForeColor="green" Font-Size="18px"></asp:Label>
                                    ...
                                    <br />
                                    <p class="clear-a">
                                        <span class="float-l input-text">Your First Name</span>
                                    ...
                                    <p class="clear-a">
                                        <span class="float-l input-text">Your Last Name</span>
                                    ...
                                    <p class="clear-a">
                                        <span class="float-l input-text">Your Email</span>
                                        <span class="float-l input-field" style="width: 80% !important">
                                            <table class="tblfrm">
                                                <tr>
                                                    <td>
                                    ...
                                    <p class="clear-a">
                                        <span class="float-l input-text">Nominee Phone</span>
                                <span class="float-l input-field" style="width: 80% !important">
                                            <table class="tblfrm">
                                                <tr>
                                                    <td>
                                    ...
                                    <p class="clear-a">
                                        <span class="float-l input-text">Nominee City </span>
                                <span class="float-l input-field" style="width: 80% !important">
                                            <table class="tblfrm">
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:DropDownList ID="ddlIntrest" runat="server" Style="width: 300px">
                                                            <asp:ListItem> -Select Nomination-</asp:ListItem>
                                                            <asp:ListItem>Business / Organization</asp:ListItem>
                                    ...
                                    <p class="clear-a">
                                        <span class="float-l input-text">Reason For Nomination</span>
                                        <span class="float-l input-field">
                                            <table class="tblfrm">
                                                <tr>
                                                    <td>
                    ...
                    <div class="grid-unit width-2of3">
                        ...
                        <div class="grid-row grid-padding">
                            <h6 class="grid-unit width-7of20 margin-bottom">
                                <a class="link-7" href="worldwide-search.aspx">FiveStarCertified.com </a>
                            </h6>
                            <!-- / .grid-unit -->
                        ...
                        <div class="grid-row grid-padding">
                            ...
                            <ul class="grid-unit width-13of20 list-delim">
                                ...
                                <li class="list-delim-item">
                                    <a href="get-certified.aspx" class="link-8">Become a FiveStarCertified business</a>
                                </li>
                            </ul>
                            <!-- / .grid-unit -->
                        </div>
